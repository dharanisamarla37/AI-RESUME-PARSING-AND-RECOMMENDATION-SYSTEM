...
def run():
    ...
    img = Image.open(r'C:\Users\srava\AI-Resume-Analyzer\App\Logo\resume new1.png')
    st.image(img)
    ...
    if choice == 'User':
        ...
        #act_jobtitle=st.text_input('Job Title')
        act_jobdescription=st.text_area('Job Description', height=200)
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin123':
                ...
                st.success("Welcome Buddy ! Total %d " % values + " User's Have Used Our Tool : )")                
